        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((category) => (
            <Link key={category.name} to={category.href}>
              <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-background hover:bg-accent-pearl/50">
                <CardContent className="p-0">
                  <div className="aspect-square bg-accent-linen mb-6 rounded-t-lg"></div>
                  <div className="p-6">
